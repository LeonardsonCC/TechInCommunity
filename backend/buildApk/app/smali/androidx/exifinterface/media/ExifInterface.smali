...
.method private constructor <init>(Ljava/io/InputStream;Z)V
    ...
    invoke-static {v1}, Landroidx/exifinterface/media/ExifInterface;->isExifDataOnly(Ljava/io/BufferedInputStream;)Z
...
.method private getHeifAttributes(Landroidx/exifinterface/media/ExifInterface$ByteOrderedDataInputStream;)V
    ...
    :try_start_2
    iput v12, v14, Landroidx/exifinterface/media/ExifInterface;->mExifOffset:I
...
.method private getJpegAttributes(Landroidx/exifinterface/media/ExifInterface$ByteOrderedDataInputStream;II)V
    ...
    .line 5544
    .local v13, "value":[B
    iput v14, v0, Landroidx/exifinterface/media/ExifInterface;->mExifOffset:I
...
.method private getPngAttributes(Landroidx/exifinterface/media/ExifInterface$ByteOrderedDataInputStream;)V
    ...
    .line 6055
    invoke-static {v2}, Landroidx/exifinterface/media/ExifInterface;->byteArrayToHexString([B)Ljava/lang/String;
...
.method private getRafAttributes(Landroidx/exifinterface/media/ExifInterface$ByteOrderedDataInputStream;)V
    ...
    sget-object v11, Landroidx/exifinterface/media/ExifInterface;->TAG_RAF_IMAGE_SIZE:Landroidx/exifinterface/media/ExifInterface$ExifTag;
    ...
    .line 5701
    .local v13, "imageLengthAttribute":Landroidx/exifinterface/media/ExifInterface$ExifAttribute;
    iget-object v14, v0, Landroidx/exifinterface/media/ExifInterface;->mExifByteOrder:Ljava/nio/ByteOrder;
    ...
    .line 5703
    .local v14, "imageWidthAttribute":Landroidx/exifinterface/media/ExifInterface$ExifAttribute;
    ...
    .end local v13    # "imageLengthAttribute":Landroidx/exifinterface/media/ExifInterface$ExifAttribute;
    .end local v14    # "imageWidthAttribute":Landroidx/exifinterface/media/ExifInterface$ExifAttribute;
...
.method private handleThumbnailFromJfif(Landroidx/exifinterface/media/ExifInterface$ByteOrderedDataInputStream;Ljava/util/HashMap;)V
    ...
    .line 6939
    invoke-virtual {p1, v5}, Landroidx/exifinterface/media/ExifInterface$ByteOrderedDataInputStream;->readFully([B)V
...
.method private handleThumbnailFromStrips(Landroidx/exifinterface/media/ExifInterface$ByteOrderedDataInputStream;Ljava/util/HashMap;)V
    ...
    invoke-static {v14, v9, v10, v13, v15}, Ljava/lang/System;->arraycopy(Ljava/lang/Object;ILjava/lang/Object;II)V
...
.method private readImageFileDirectory(Landroidx/exifinterface/media/ExifInterface$ByteOrderedDataInputStream;I)V
    ...
    .local v28, "tag":Landroidx/exifinterface/media/ExifInterface$ExifTag;
    int-to-long v4, v2
    ...
    .end local v26    # "i":S
    .end local v27    # "dataFormat":I
    .end local v28    # "tag":Landroidx/exifinterface/media/ExifInterface$ExifTag;
    .local v3, "numberOfDirectoryEntry":S
    ...
    .restart local v26    # "i":S
    .restart local v27    # "dataFormat":I
    .restart local v28    # "tag":Landroidx/exifinterface/media/ExifInterface$ExifTag;
    :goto_8
    sget-object v2, Landroidx/exifinterface/media/ExifInterface;->sExifPointerTagMap:Ljava/util/HashMap;
    ...
    .end local v28    # "tag":Landroidx/exifinterface/media/ExifInterface$ExifTag;
    .local v15, "tag":Landroidx/exifinterface/media/ExifInterface$ExifTag;
    ...
    const-string v13, "Offset: %d, tagName: %s"
    ...
    .line 6763
    .end local v15    # "tag":Landroidx/exifinterface/media/ExifInterface$ExifTag;
    .restart local v28    # "tag":Landroidx/exifinterface/media/ExifInterface$ExifTag;
    :cond_1f
    move-object/from16 v15, v28
    ...
    .line 6770
    .end local v28    # "tag":Landroidx/exifinterface/media/ExifInterface$ExifTag;
    .restart local v15    # "tag":Landroidx/exifinterface/media/ExifInterface$ExifTag;
    :goto_a
    ...
    .restart local v11    # "byteCount":J
    :cond_21
    move-wide/from16 v21, v11

    .line 6781
    .end local v11    # "byteCount":J
    .restart local v21    # "byteCount":J
    :cond_22
    sget-boolean v3, Landroidx/exifinterface/media/ExifInterface;->DEBUG:Z
    ...
    iget v5, v0, Landroidx/exifinterface/media/ExifInterface;->mExifOffset:I
    ...
    .line 6793
    new-instance v21, Landroidx/exifinterface/media/ExifInterface$ExifAttribute;
    ...
    .local v27, "numberOfComponents":I
    ...
    .line 6795
    .local v12, "attribute":Landroidx/exifinterface/media/ExifInterface$ExifAttribute;
    iget-object v13, v0, Landroidx/exifinterface/media/ExifInterface;->mAttributes:[Ljava/util/HashMap;

    aget-object v13, v13, p2

    iget-object v15, v3, Landroidx/exifinterface/media/ExifInterface$ExifTag;->name:Ljava/lang/String;

    invoke-virtual {v13, v15, v12}, Ljava/util/HashMap;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    .line 6800
    iget-object v13, v3, Landroidx/exifinterface/media/ExifInterface$ExifTag;->name:Ljava/lang/String;
    ...
    iput v13, v0, Landroidx/exifinterface/media/ExifInterface;->mMimeType:I
    ...
    .line 6808
    invoke-virtual {v12, v13}, Landroidx/exifinterface/media/ExifInterface$ExifAttribute;->getStringValue(Ljava/nio/ByteOrder;)Ljava/lang/String;
    ...
    .line 6810
    invoke-virtual {v12, v13}, Landroidx/exifinterface/media/ExifInterface$ExifAttribute;->getIntValue(Ljava/nio/ByteOrder;)I
    ...
    .local v15, "nextIfdType":Ljava/lang/Integer;
    .restart local v28    # "tag":Landroidx/exifinterface/media/ExifInterface$ExifTag;
    int-to-long v2, v13
    ...
    .end local v12    # "attribute":Landroidx/exifinterface/media/ExifInterface$ExifAttribute;
    .end local v14    # "dataFormat":I
    .end local v15    # "nextIfdType":Ljava/lang/Integer;
    .end local v24    # "valid":Z
    .end local v27    # "numberOfComponents":I
    .end local v28    # "tag":Landroidx/exifinterface/media/ExifInterface$ExifTag;
    :cond_2a
    :goto_c
...
.method private saveWebpAttributes(Ljava/io/InputStream;Ljava/io/OutputStream;)V
    ...
    .line 6389
    .local v0, "totalInputStream":Landroidx/exifinterface/media/ExifInterface$ByteOrderedDataInputStream;
    new-instance v1, Landroidx/exifinterface/media/ExifInterface$ByteOrderedDataOutputStream;
    ...
    .line 6393
    .local v1, "totalOutputStream":Landroidx/exifinterface/media/ExifInterface$ByteOrderedDataOutputStream;
    sget-object v2, Landroidx/exifinterface/media/ExifInterface;->WEBP_SIGNATURE_1:[B
    ...
    .line 6400
    .local v2, "nonHeaderByteArrayOutputStream":Ljava/io/ByteArrayOutputStream;
    :try_start_0
    new-instance v4, Ljava/io/ByteArrayOutputStream;
    ...
    .line 6405
    .local v4, "nonHeaderOutputStream":Landroidx/exifinterface/media/ExifInterface$ByteOrderedDataOutputStream;
    ...
    .line 6410
    .local v5, "bytesRead":I
    iget v6, p0, Landroidx/exifinterface/media/ExifInterface;->mExifOffset:I
    ...
    invoke-static {v0, v4, v6}, Landroidx/exifinterface/media/ExifInterface;->copy(Ljava/io/InputStream;Ljava/io/OutputStream;I)V
    ...
    .end local v3    # "exifChunkLength":I
    .end local v5    # "bytesRead":I
    goto/16 :goto_4
    ...
    .line 6443
    .local v8, "containsAnimation":Z
    :goto_1
    sget-object v9, Landroidx/exifinterface/media/ExifInterface;->WEBP_CHUNK_TYPE_VP8X:[B

    invoke-virtual {v4, v9}, Landroidx/exifinterface/media/ExifInterface$ByteOrderedDataOutputStream;->write([B)V

    .line 6444
    invoke-virtual {v4, v6}, Landroidx/exifinterface/media/ExifInterface$ByteOrderedDataOutputStream;->writeInt(I)V

    .line 6445
    invoke-virtual {v4, v7}, Landroidx/exifinterface/media/ExifInterface$ByteOrderedDataOutputStream;->write([B)V

    .line 6454
    if-eqz v8, :cond_5

    .line 6455
    sget-object v9, Landroidx/exifinterface/media/ExifInterface;->WEBP_CHUNK_TYPE_ANIM:[B

    const/4 v10, 0x0

    invoke-direct {p0, v0, v4, v9, v10}, Landroidx/exifinterface/media/ExifInterface;->copyChunksUpToGivenChunkType(Landroidx/exifinterface/media/ExifInterface$ByteOrderedDataInputStream;Landroidx/exifinterface/media/ExifInterface$ByteOrderedDataOutputStream;[B[B)V
    ...
    .line 6462
    .local v10, "read":I
    sget-object v11, Landroidx/exifinterface/media/ExifInterface;->WEBP_CHUNK_TYPE_ANMF:[B
    ...
    .line 6467
    :cond_4
    invoke-direct {p0, v0, v4, v9}, Landroidx/exifinterface/media/ExifInterface;->copyWebPChunk(Landroidx/exifinterface/media/ExifInterface$ByteOrderedDataInputStream;Landroidx/exifinterface/media/ExifInterface$ByteOrderedDataOutputStream;[B)V
    ...
    invoke-direct {p0, v0, v4, v3, v9}, Landroidx/exifinterface/media/ExifInterface;->copyChunksUpToGivenChunkType(Landroidx/exifinterface/media/ExifInterface$ByteOrderedDataInputStream;Landroidx/exifinterface/media/ExifInterface$ByteOrderedDataOutputStream;[B[B)V
    ...
    .end local v6    # "size":I
    .end local v7    # "data":[B
    .end local v8    # "containsAnimation":Z
    :goto_3
    goto :goto_4
    ...
    .line 6494
    .end local v4    # "nonHeaderOutputStream":Landroidx/exifinterface/media/ExifInterface$ByteOrderedDataOutputStream;
    invoke-static {v2}, Landroidx/exifinterface/media/ExifInterface;->closeQuietly(Ljava/io/Closeable;)V
    ...
    .line 6478
    .restart local v4    # "nonHeaderOutputStream":Landroidx/exifinterface/media/ExifInterface$ByteOrderedDataOutputStream;
    .restart local v5    # "firstChunkType":[B
    :cond_7
    :try_start_1
    new-instance v3, Ljava/io/IOException;

    const-string v6, "WebP files with only VP8 or VP8L chunks are currently not supported"

    invoke-direct {v3, v6}, Ljava/io/IOException;-><init>(Ljava/lang/String;)V

    .end local v0    # "totalInputStream":Landroidx/exifinterface/media/ExifInterface$ByteOrderedDataInputStream;
    .end local v1    # "totalOutputStream":Landroidx/exifinterface/media/ExifInterface$ByteOrderedDataOutputStream;
    .end local v2    # "nonHeaderByteArrayOutputStream":Ljava/io/ByteArrayOutputStream;
    .end local p1    # "inputStream":Ljava/io/InputStream;
    .end local p2    # "outputStream":Ljava/io/OutputStream;
    throw v3

    .line 6425
    .restart local v0    # "totalInputStream":Landroidx/exifinterface/media/ExifInterface$ByteOrderedDataInputStream;
    .restart local v1    # "totalOutputStream":Landroidx/exifinterface/media/ExifInterface$ByteOrderedDataOutputStream;
    .restart local v2    # "nonHeaderByteArrayOutputStream":Ljava/io/ByteArrayOutputStream;
    ...
    const-string v5, "Failed to save WebP file"

...
if(option == "create_supermarket"):
    ...
    r = requests.post("https://tech.leonardson.cc/node/supermarket", json=mercado_exemplo)

    print(r.text)
elif(option == "update_supermarket"):
    headers = {
    'Authorization':'Bearer eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJleHAiOjE2MjE5ODQyNDksImlkIjoxLCJ0eXBlIjoic3VwZXJtYXJrZXQifQ.Pud3hQHJCzIh8Kw90YATep279rnSO0uccE-ZT-MMODQ'
    }
    ...
    r = requests.post("http://192.168.10.104:8081/supermarket/login", json=data)
    ...
    headers = {
    'Authorization':'Bearer eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJleHAiOjE2MjE0NjYyMTMsImlkIjo1LCJ0eXBlIjoic3VwZXJtYXJrZXQifQ.BbtS15Av6TAk4r1aq49Q39EzAiKc-QK12uevHKJk7lQ'
    }
    ...
    headers = {
    'Authorization':'Bearer eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJleHAiOjE2MjM2Mjg4MjMsImlkIjoxLCJ0eXBlIjoic3VwZXJtYXJrZXQifQ.sovmHAEY4d93bLRlPlAUYrF5ClBWG_SC_9MiSLo94cA'
    }

    r = requests.post("http://192.168.10.104:8081/supermarket/download", headers=headers)

    with open('apk_baixado.apk', 'wb') as f:
        f.write(r.content)
